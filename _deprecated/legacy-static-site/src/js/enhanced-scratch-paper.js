...
<p></p>
  ...
  createToggleTab() {
    ...
    toggleTab.innerHTML = getIconString("edit", 16) + " Scratch Paper";
  ...
  createHeader() {
    ...
    minimizeBtn.innerHTML = getIconString("minus", 16);
  ...
  createTabsSystem() {
    ...
    addTabBtn.innerHTML = getIconString("plus", 16);
  ...
  createSearch() {
    ...
    searchIcon.innerHTML = getIconString("telescope", 16);
  ...
  renderTabs() {
    ...
    this.tabs.forEach((tab) => {
      ...
      closeBtn.innerHTML = getIconString("x", 12);
  ...
  showAutoSaveIndicator(state) {
    const icon = this.autoSaveIndicator.querySelector(
      ".scratch-auto-save-icon",
    );
    const text = this.autoSaveIndicator.querySelector(
      ".scratch-auto-save-text",
    );
    ...
    switch (state) {
      case "saving":
        icon.innerHTML = getIconString("clock", 14);
        text.textContent = "Saving...";
        break;
      case "saved":
        icon.innerHTML = getIconString("check", 14);
        text.textContent = "Saved";
        break;
      default:
        icon.innerHTML = getIconString("save", 14);
  ...
  attachEventListeners() {
    ...
    document.addEventListener("keydown", (e) => {
      ...
      if (!this.currentEditor || this.currentEditor !== document.activeElement)
        return;
