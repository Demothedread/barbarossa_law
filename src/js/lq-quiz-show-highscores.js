...
export class QuizShowHighScores {
  ...
  createScoreRow(score, rank, currentScore) {
    ...
    return `
      <div class="score-row ${rankClass} ${isCurrentScore ? 'current-score' : ''}" data-rank="${rank}">
        ...
        <div class="score-details">
          <div class="score-main">
            ...
            <span class="traditional-score">(${score.traditionalScore} - ${score.percentage}%)</span>
          </div>
