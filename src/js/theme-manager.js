...
class EffectsManager {
  ...
  createClickExplosion(event) {
    ...
    const interactive = event.target.closest(
      "button, .choice-item, .nav-btn, .theme-btn",
    );
