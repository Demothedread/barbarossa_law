                    ...
                    <form id="preferencesForm">
                        <div class="form-group">
                            ...
                            <select id="themeSelect" name="theme_preference">
                                <option value="classic" ${user.theme_preference === 'classic' ? 'selected' : ''}>Dorothy Draper Classic</option>
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" id="backgroundMusicEnabled" name="background_music_enabled" 
                                       ${user.background_music_enabled ? 'checked' : ''}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="range" id="volumeLevel" name="volume_level" 
                                   min="0" max="1" step="0.1" value="${user.volume_level || 0.7}">
                            <span id="volumeDisplay">${Math.round((user.volume_level || 0.7) * 100)}%</span>
                        </div>
